...
export const uiCopy = {
  zh: {
    ...
    pause: '暂停',
    resume: '继续',
    denoiseHint: '尝试让噪声安静下来',
    forceTip: '按住左键牵引，按住右键推开',
    actionCard: '行动卡',
    drawAnother: '换一张卡',
    ...
    heatLow: '温度已经降下来了',
    heatHigh: '先把热度往下调',
    heatCopy: '慢呼气、松肩颈、延迟回复。这里不做发泄动作。',
    inhale: '吸 1 2 3 4',
  ...
  en: {
    ...
    pause: 'Pause',
    resume: 'Resume',
    denoiseHint: 'Try quieting the noise',
    forceTip: 'Hold left to pull, hold right to push',
    ...
    heatCopy: 'Slow exhale, release shoulders and neck, delay replies. No venting actions here.',
    inhale: 'In 1 2 3 4',
...
const interventionEnglish: Record<BrainState, Pick<Intervention, 'title' | 'subtitle' | 'triggerLabels' | 'steps' | 'evidence' | 'cautions'>> = {
  ...
  anger: {
    ...
    steps: [
      { title: 'Lower arousal first', body: 'Use slow exhale and relaxed shoulders/neck to bring body heat down.', cue: 'No venting actions here.' },
